...
const Register = () => {
    const { register, watch, handleSubmit, formState: { errors}, } = useForm<RegisterFormData>(); // Destructure watch from useForm
    ...
    return (
        <form className="flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <span>
                <button type ="submit"
                className="bg-blue-600 text-white p-2 font-bold hover: bg-blue text-xl">
                Create Account
                </button>
            </span>
        </form>
